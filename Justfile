kurtosis-devnet-up: build-debug kurtosis-spawn
...
kurtosis-spawn:
    ...
    kurtosis run github.com/cbarbieru/optimism-package --args-file ./scripts/ci/kurtosis-params.yaml --enclave op-rollup-boost
